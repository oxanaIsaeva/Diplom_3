...
class TestRestorePasswordPage:
    ...
    def setup_class(cls):
        ...
        TestRestorePasswordPage.accessToken = format_response["accessToken"]
    ...
    def test_jump_to_restore_password_page(self, driver):
        ...
        assert driver.current_url == Links.FORGOT_PASSWORD_URL
    ...
    def test_click_to_restore_button(self, driver):
        ...
        restore_pass_page.set_text_to_element(RestorePasswordLocators.EMAIL_FIELD, TestRestorePasswordPage.email)
    ...
    def test_click_to_show_password(self, driver):
        ...
        restore_pass_page.set_text_to_element(RestorePasswordLocators.NEW_PASSWORD_FIELD,
                                              TestRestorePasswordPage.password)
    ...
    def teardown_class(cls):
        requests.delete(f'{Links.URL}/api/auth/user',
                        headers={"Authorization": TestRestorePasswordPage.accessToken})
